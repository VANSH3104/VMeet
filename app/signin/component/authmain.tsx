...
export const Authmain = () => {
  ...
  return (
    <div className="bg-white  p-3 ">
      ...
      <CardHeader>
        <CardTitle className="flex text-4xl font-bold font-openSans justify-center pb-4">Create Your Cv</CardTitle>
      </CardHeader>
      <CardContent>
      <form onSubmit={handleSubmit(onSubmit)} className=" rounded">
        ...
        <button type="submit" className="mt-2 bg-blue-700 text-lg font-semibold text-white py-2 w-full rounded hover:bg-blue-600">
      ...
      <div className="mt-4 flex justify-center gap-7">
        <Social
          icon={BsGithub}
          onclick={() => clicking("github")}
        />
        <Social
          icon={BsGoogle}
          onclick={() => clicking("google")}
        />
      </div>
